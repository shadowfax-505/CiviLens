        ...
        <div class="flex flex-wrap gap-2">
            ...
            @unless ($archived)
                ...
                @if (auth()->user()?->hasRole(config('civiclens.roles.staff')) === true)
                    <a href="{{ route('admin.change-requests.create', ['module' => 'procurement', 'operation' => 'create', 'subject_label' => 'New tender', 'subject_url' => route('admin.procurement.tenders.index')]) }}" class="rounded border border-emerald-300 px-4 py-2 text-sm font-semibold text-emerald-700 dark:border-emerald-800 dark:text-emerald-300">Propose tender</a>
                @endif
            @endunless
        </div>
    </div>
