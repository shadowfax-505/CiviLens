...
If Composer refuses because the directory is not empty, use a temporary directory, then move generated Laravel application files into this repo without deleting `docs/` or `.github/`.
