...
- `npm run test:orbital` verifies seamless asset generation, no-data detection, color matching, eight-pixel feathering, candidate validation, manifest provenance, and the review-only refresh workflow.
